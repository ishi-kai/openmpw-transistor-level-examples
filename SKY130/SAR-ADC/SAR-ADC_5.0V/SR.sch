...
N 290 -300 290 -240 {lab=Qn}
N 50 -120 190 -120 {lab=#net1}
N 160 -210 250 -210 {lab=S_bar}
N 190 -120 250 -120 {lab=#net1}
N 50 -210 160 -210 {lab=S_bar}
N 80 -330 100 -330 {lab=#net1}
N 80 -330 80 -120 {lab=#net1}
...
N 290 -280 390 -280 {lab=Qn}
N 140 -300 140 -280 {lab=Qn}
N 140 -280 290 -280 {lab=Qn}
...
N 300 290 300 350 {lab=#net1}
N 60 470 200 470 {lab=R_bar}
N 170 380 260 380 {lab=Qn}
N 200 470 260 470 {lab=R_bar}
N 60 380 170 380 {lab=Qn}
N 90 260 90 470 {lab=R_bar}
N 220 260 260 260 {lab=Qn}
N 220 260 220 380 {lab=Qn}
...
N 300 310 400 310 {lab=#net1}
N 150 290 150 310 {lab=#net1}
N 150 310 300 310 {lab=#net1}
...
N 50 -120 50 10 {lab=#net1}
N 50 10 350 10 {lab=#net1}
N 350 10 350 310 {lab=#net1}
N 60 80 60 380 {lab=Qn}
N 60 80 370 80 {lab=Qn}
N 370 -280 370 80 {lab=Qn}
...
C {devices/opin.sym} 390 -280 0 0 {name=p8 lab=Qn}
C {devices/opin.sym} 400 310 0 0 {name=p6 lab=Q}
