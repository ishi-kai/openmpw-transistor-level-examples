...
C {sky130_fd_pr/cap_var_hvt.sym} 420 -50 0 0 {name=C1 model=cap_var_hvt W=7.07 L=7.07 VM=1 spiceprefix=X}
C {sky130_fd_pr/cap_var_hvt.sym} 580 -50 0 0 {name=C2 model=cap_var_hvt W=10 L=10 VM=1 spiceprefix=X}
C {sky130_fd_pr/cap_var_hvt.sym} 720 -50 0 0 {name=C3 model=cap_var_hvt W=14.14 L=14.14 VM=1 spiceprefix=X}
C {sky130_fd_pr/cap_var_hvt.sym} 880 -50 0 0 {name=C4 model=cap_var_hvt W=20 L=20 VM=1 spiceprefix=X}
C {sky130_fd_pr/cap_var_hvt.sym} 1020 -50 0 0 {name=C5 model=cap_var_hvt W=28.28 L=28.28 VM=1 spiceprefix=X}
