...
C {primitives/pfet.sym} -27.6576099915567 0 0 0 {name=M2 
model=pmos
W=300u
L=2u
m=1
}
C {primitives/nfet.sym} -30 -110 0 0 {name=M1
model=nmos
W=100u
L=2u
m=1
}
C {primitives/pfet.sym} -180 0 0 1 {name=M6 
model=pmos
W=30u
L=2u
m=1
}
C {primitives/nfet.sym} -220 130 0 0 {name=M5 
model=nmos
W=10u
L=2u
m=1
}
C {primitives/nfet.sym} -180 -110 0 1 {name=M4 
model=nmos
W=10u
L=2u
m=1
}
C {primitives/pfet.sym} -217.6576099915567 -240 0 0 {name=M3 
model=pmos
W=40u
L=2u
m=1
