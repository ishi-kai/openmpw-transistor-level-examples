...
C {devices/vsource.sym} 40 -170 0 0 {name=Vdd value=5.0}
C {devices/vsource.sym} 100 -170 0 0 {name=Vb value=3.5}
...
C {devices/vsource.sym} 180 -140 0 0 {name=Vin value="pwl 0 0 1n 0 1.1n 5.0"}
C {devices/lab_pin.sym} 180 -220 0 0 {name=p2 sig_type=std_logic lab=in}
C {2stage_pc.sym} 300 -200 0 0 {name=X1}
C {devices/code.sym} -200 -360 0 0 {name=PTC06_MODELS
only_toplevel=true
