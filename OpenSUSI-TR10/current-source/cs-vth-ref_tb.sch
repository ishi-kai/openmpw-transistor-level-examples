...
C {devices/code.sym} -240 -510 0 0 {name=TR-1um_MODELS
only_toplevel=true
format="tcleval( @value )"
value=".include $::LIB/ip62_models"
spice_ignore=false}
C {MN.sym} 140 -180 0 1 {name=M1 model=NMOS w=50u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {MN.sym} 180 -230 0 0 {name=M2 model=NMOS w=50u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {MP.sym} 140 -390 0 1 {name=M3 model=PMOS w=150u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {MP.sym} 180 -390 0 0 {name=M4 model=PMOS w=150u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {RS.sym} 450 -290 0 0 {name=R2
w=4e-6
R=2495
l=100e-6
model=F_RS
...
tc1=0
tc2=0}
C {MP.sym} 880 -390 0 0 {name=M5 model=PMOS w=30u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {MN.sym} 960 -170 0 1 {name=M6 model=NMOS w=10u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {MN.sym} 1000 -170 0 0 {name=M7 model=NMOS w=10u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
