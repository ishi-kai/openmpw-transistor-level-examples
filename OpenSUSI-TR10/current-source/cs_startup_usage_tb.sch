...
C {devices/code.sym} -300 -500 0 0 {name=TR-1um_MODELS
only_toplevel=true
format="tcleval( @value )"
value=".include $::LIB/ip62_models"
spice_ignore=false}
C {devices/vdd.sym} 590 -450 0 0 {name=l4}
C {MP.sym} 560 -350 0 1 {name=M5 model=PMOS w=120u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {MP.sym} 600 -350 0 0 {name=M6 model=PMOS w=120u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {MN.sym} 600 -190 0 0 {name=M7 model=NMOS w=30u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {MN.sym} 560 -140 0 1 {name=M8 model=NMOS w=30u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {RR.sym} 640 -90 0 0 {name=R2
w=4e-06
R=1
l=80e-06
model=F_RR
...
C {MP.sym} 340 -270 0 1 {name=M1 model=PMOS w=10u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {MN.sym} 340 -90 0 1 {name=M2 model=NMOS w=5000u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {MN.sym} 210 -170 0 1 {name=M3 model=NMOS w=10u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
