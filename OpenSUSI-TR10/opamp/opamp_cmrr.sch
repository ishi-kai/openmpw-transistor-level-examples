...
C {devices/vsource.sym} 200 -220 0 0 {name=Vinp value="DC 2.5 AC 1"}
...
footprint=1206
device="ceramic capacitor"}
C {devices/isource.sym} 140 -480 0 0 {name=I1 value=10e-6}
C {devices/gnd.sym} 140 -380 0 0 {name=l7 lab=GND}
C {devices/gnd.sym} 200 -180 0 0 {name=l8 lab=GND}
C {devices/code.sym} -480 -460 0 0 {name=TR-1um_MODELS
only_toplevel=true
