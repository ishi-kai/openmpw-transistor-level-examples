...
N 20 -200 20 -170 {
lab=GND}
N 180 -280 210 -280 {lab=vb}
N 650 -280 680 -280 {lab=vb}
C {devices/code_shown.sym} -360 -310 0 0 {name=control only_toplevel=false value=".option savecurrent
.control
set units=degree
op
save all
...
C {devices/code_shown.sym} -360 -90 0 0 {name=measure only_toplevel=false value=".measure ac gain_vdd find vdb(outp) at=1e3
...
C {devices/code.sym} -370 -460 0 0 {name=TR-1um_MODELS
only_toplevel=true
format="tcleval( @value )"
value=".include $::LIB/ip62_models"
spice_ignore=false}
C {opamp.sym} 230 -240 0 0 {name=X1}
C {opamp.sym} 700 -240 0 0 {name=X2}
C {devices/isource.sym} 20 -230 0 0 {name=I0 value=10e-6}
C {devices/gnd.sym} 20 -170 0 0 {name=l6 lab=GND}
C {devices/lab_pin.sym} 20 -280 0 1 {name=p2 sig_type=std_logic lab=vb}
C {devices/lab_pin.sym} 180 -280 0 0 {name=p4 sig_type=std_logic lab=vb}
C {devices/lab_pin.sym} 650 -280 0 0 {name=p5 sig_type=std_logic lab=vb}
