...
C {MP.sym} 450 -30 0 1 {name=M3 model=PMOS w=400u l=4u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {MP.sym} 520 -30 0 0 {name=M4 model=PMOS w=400u l=4u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
