...
N 1320 -620 1320 -540 {lab=#net17}
N 1320 -480 1320 -360 {lab=#net15}
N 1320 -300 1320 -180 {lab=#net18}
...
N 1920 -840 1920 -720 {lab=BPO}
N 1920 -1200 1920 -1080 {lab=VDD}
N 1940 -1200 1940 -1080 {lab=VDD}
N 1920 -1200 1940 -1200 {lab=VDD}
N 1840 -1050 1880 -1050 {lab=BPO}
N 1840 -870 1880 -870 {lab=#net19}
N 1560 -1200 1920 -1200 {lab=VDD}
N 1760 -1050 1840 -1050 {lab=BPO}
N 1760 -870 1840 -870 {lab=#net19}
...
N 1320 -960 1680 -960 {lab=#net17}
N 1160 -690 1400 -690 {lab=INM}
N 1320 -960 1320 -620 {lab=#net17}
...
N 1920 -660 1920 -360 {lab=BPO}
N 1680 -660 1680 -360 {lab=#net19}
N 1000 -360 1320 -360 {lab=#net15}
N 1660 -330 1660 -0 {lab=VSS}
N 1940 -330 1940 -0 {lab=VSS}
N 1680 -720 1680 -660 {lab=#net19}
N 1920 -720 1920 -660 {lab=BPO}
N 300 -1200 480 -1200 {lab=VDD}
N 300 -1180 320 -1180 {lab=BPO}
N 300 -1000 320 -1000 {lab=BPI}
N 280 0 420 -0 {lab=VSS}
N 1680 -800 1740 -800 {lab=#net19}
N 1680 -400 1740 -400 {lab=#net19}
N 1740 -400 1740 -330 {lab=#net19}
N 1740 -870 1740 -800 {lab=#net19}
N 2040 0 2260 0 {lab=VSS}
N 2140 -1200 2280 -1200 {lab=VDD}
N 2260 0 2280 0 {lab=VSS}
N 2260 -590 2320 -590 {lab=OUT}
N 2260 -290 2260 0 {lab=VSS}
N 2260 -460 2260 -290 {lab=VSS}
N 2260 -480 2260 -460 {lab=VSS}
N 2260 -510 2280 -510 {lab=VSS}
N 2280 -510 2280 0 {lab=VSS}
N 2260 -660 2260 -540 {lab=OUT}
N 2260 -590 2320 -590 {lab=OUT}
N 2260 -1200 2260 -1080 {lab=VDD}
N 2260 -1050 2280 -1050 {lab=VDD}
N 2180 -1050 2220 -1050 {lab=BPO}
N 2260 -1020 2260 -720 {lab=OUT}
N 2260 -720 2260 -660 {lab=OUT}
N 2280 -1200 2280 -1050 {lab=VDD}
N 1940 -1200 2140 -1200 {lab=VDD}
N 1920 -510 2220 -510 {lab=BPO}
N 2130 -920 2260 -920 {lab=OUT}
N 1940 0 2040 -0 {lab=VSS}
N 1920 -920 2070 -920 {lab=#net14}
...
C {MP.sym} 840 -690 0 0 {name=MINPP3 model=PMOS w=12u l=8u m=4 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
...
C {MP.sym} 1160 -690 0 1 {name=MINMP3 model=PMOS w=12u l=8u m=4 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
...
C {MN.sym} 960 -510 0 0 {name=MINPN3 model=NMOS w=12u l=8u m=2 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
...
C {MN.sym} 1360 -510 0 1 {name=MINMN3 model=NMOS w=12u l=8u m=2 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
...
C {devices/lab_wire.sym} 1800 -150 0 1 {name=p10 sig_type=std_logic lab=BNO}
C {devices/lab_wire.sym} 1800 -1050 0 1 {name=p12 sig_type=std_logic lab=BPO}
C {MN.sym} 2220 -510 0 0 {name=MDRVN model=NMOS w=12u l=8u m=48 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {devices/opin.sym} 2320 -590 0 0 {name=p15 lab=OUT}
C {MP.sym} 2220 -1050 0 0 {name=MDRVP1 model=PMOS w=12u l=8u m=96 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {devices/capa.sym} 2100 -920 1 0 {name=C1
m=1
value=10p
footprint=1206
device="ceramic capacitor"}
C {devices/lab_wire.sym} 2200 -1050 0 0 {name=p18 sig_type=std_logic lab=BPO}
