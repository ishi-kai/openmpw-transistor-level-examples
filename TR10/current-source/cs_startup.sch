...
spice_ignore=false}
C {IP62LIB/MP.sym} 230 -270 0 1 {name=XM1 model=PMOS w=10u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
C {IP62LIB/MN.sym} 230 -90 0 1 {name=XM2 model=NMOS w=5000u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
C {IP62LIB/MN.sym} 100 -170 0 1 {name=XM3 model=NMOS w=10u l=1u m=1 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0}
